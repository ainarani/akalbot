        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h1 class="m-0">2.1 Permasalahan</h1>
                    <small class="text-muted">Dalam permainan tradisional tuju selipar, selipar perlu dijatuhkan dalam jarak tertentu. Asas permainan ini ialah satu selipar perlu dibaling kepada satu susunan selipar untuk meruntuhkannya. Rajah 1 menunjukkan seorang kanak-kanak sedang cuba membaling selipar ke arah susunan selipar.</small>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
