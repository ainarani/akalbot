...
// *********************************************************************************************************************************
//FAHMI CUSTOM BLOCKS
Blockly.Blocks.customBlocks = {};

//INPUT AND OUTPUT FOR ARDUINO
...
Blockly.Blocks['input_variable'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldTextInput("put your function name here"), "variable");
...
Blockly.Blocks.new_text = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField("Stesen")
            .appendField(new Blockly.FieldTextInput("senjata"), "text");
        this.setPreviousStatement(false, null);
        this.setNextStatement(false, null);
        this.setOutput(true, "Stesen");
        this.setTooltip('');
        this.setColour(345);
    }
};

Blockly.Blocks.var_stesen = {
    init: function () {
        this.setColour(345);
        this.appendDummyInput().appendField("STESEN")
            .appendField(new Blockly.FieldTextInput("no.stesen"), "text")
            .setAlign(Blockly.ALIGN_LEFT)
        this.appendValueInput("No. Stesen", "Number")
            .setCheck(!0, null)
...
Blockly.Blocks.output_analog = {
    init: function () {
        this.appendDummyInput()
            .appendField("AnalogRead Pin#").appendField(new Blockly.FieldDropdown(profile["default"].analog), "pinA");
...
Blockly.Blocks.output_digital = {
    init: function () {
        this.appendDummyInput()
            .appendField("DigitalRead PIN#").appendField(new Blockly.FieldDropdown(profile["default"].digital), "PIN");
        this.setOutput(true, null);
        this.setColour(220);
        this.setTooltip("");
        this.setHelpUrl("");
...
Blockly.Blocks.arduino_servo_def = {
    init: function () {
        this.appendDummyInput()
            .appendField("Both Servo (Defender)")
            .appendField(new Blockly.FieldImage("picture/servo.jpg", 50, 40, ""))
            .appendField(new Blockly.FieldImage("picture/servo.jpg", 50, 40, ""))
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField("STATUS")
...
Blockly.Blocks.laser_sensor = {
    init: function () {
        this.appendDummyInput()
            .appendField("Laser sensor")
            .appendField(new Blockly.FieldImage("picture/laser.jpg", 50, 40, "*"))
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField("Laser : S")
...
Blockly.Blocks.laser_detector = {
    init: function () {
        this.appendDummyInput()
            .appendField("Laser Detector")
            .appendField(new Blockly.FieldImage("picture/laser_detector.jpeg", 50, 40, "*"))
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField("Detector : Out")
            .appendField(new Blockly.FieldDropdown(profile.default.digital), "laserdetect")
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(230);
        this.setTooltip("");
...
Blockly.Blocks.laser_pointer = {
    init: function () {
        this.appendDummyInput()
            .appendField("Laser Pointer")
            .appendField(new Blockly.FieldImage("picture/pointer.jpeg", 50, 40, "*"))
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField("Pointer : P")
            .appendField(new Blockly.FieldDropdown(profile.default.digital), "laserpoint")
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(230);
        this.setTooltip("");
...
Blockly.Blocks['color_sensor'] = {
    init: function () {
        this.appendDummyInput()
            .appendField("Color sensor (Attacker)")
...
Blockly.Blocks.color_sensor_def = {
    init: function () {
        this.appendDummyInput()
            .appendField("Color sensor (Defender)")
            .appendField(new Blockly.FieldImage("picture/tcs3200.jpg", 50, 40, "*"))
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(230);
...
Blockly.Blocks.OLED_display = {
    init: function () {
        ...
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
        this.setTooltip("Display the output")
    }
};
Blockly.Blocks.OLED_text_color = {
    init: function () {
        this.setColour(60);
        this.appendDummyInput().appendField("textcolor")
            .appendField("color").appendField(new Blockly.FieldDropdown([
                ["WHITE", "WHITE"],
                ["BLACK", "BLACK"]
            ]), "COLOR");
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
        this.setTooltip("Text color change on the display")
    }
};
Blockly.Blocks.OLED_text_size = {
    init: function () {
        ...
        this.appendDummyInput().appendField("Text")
            ...
            .appendField(new Blockly.FieldDropdown(profile["default"].digital), "SIZE");
        this.setPreviousStatement(!0, null);
        this.setNextStatement(!0, null);
        this.setTooltip("Text size change on the display")
    }
};
...
Blockly.Blocks['input_switch'] = {
    init: function () {
        this.appendStatementInput("switch")
            .setCheck(null)
            .appendField("switch");
...
Blockly.Blocks['input_case'] = {
    init: function () {
        this.appendDummyInput()
            .appendField("Case")
            .appendField(new Blockly.FieldDropdown([["1", "case 1"], ["2", "case 2"], ["3", "case 3"], ["4", "case 4"], ["5", "case 5"], ["6", "case 6"]]), "cases");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip('');
        this.setColour(80);
...
Blockly.Blocks['input_array'] = {
    init: function () {
        ...
        this.setMutator(new Blockly.Mutator(['input_array_item']));
